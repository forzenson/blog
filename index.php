            ...
            <div class="block">
              ...
              <div class="block__content">
                <div class="articles articles__horizontal">
                      ...
                      <?php $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categorie_id` = 4 ORDER BY `id` DESC LIMIT 10");
                      while($art = mysqli_fetch_assoc($articles))
                      {
                        ?>
                        <article class="article">
                ...
                <div class="block">
                  ...
                  <div class="block__content">
                    <div class="articles articles__horizontal">
                          ...
                          <?php $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categorie_id` = 2 ORDER BY `id` DESC LIMIT 10");
                          while($art = mysqli_fetch_assoc($articles))
                          {
                            ?>
                            <article class="article">
